...
console.error(
  "Please run `npm install` (or `npm ci`) in backend to install devDependencies before building."
);
console.error(
  "If you intentionally built without devDependencies, provide a local `tsc` CLI in devDependencies or change your workflow to install devDependencies during build."
);
process.exit(1);
